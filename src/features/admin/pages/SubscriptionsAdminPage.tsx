...
const MODULES = [
  ...
  ['floor_plan', 'الطاولات وخريطة الصالة', 'Tables & Floor Plan'], ['inventory', 'المخزون', 'Inventory'], ['raw_materials', 'الخامات', 'Raw Materials'],
  ['products', 'المنتجات', 'Products'], ['purchases', 'المشتريات', 'Purchases'], ['production', 'الإنتاج', 'Production'],
  ['reports', 'التقارير', 'Reports'], ['accounting', 'الحسابات', 'Accounting'], ['customers', 'العملاء', 'Customers'],
  ['suppliers', 'الموردين', 'Suppliers'], ['users', 'المستخدمين', 'Users'], ['branches', 'الفروع', 'Branches'],
] as const;
