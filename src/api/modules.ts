...
export const procurement = {
  createPurchaseRequest(p: { p_branch_id: string; p_supplier_id?: string | null; p_priority?: string; p_expected_date?: string | null; p_notes?: string | null; p_items?: import('@/lib/types').ProcurementLineInput[] | null }): ApiResult<RpcResult & { request_id?: string; request_number?: string; items_added?: number }> { return rpc('create_purchase_request', p); },
  ...
  createRfq(p: { p_branch_id: string; p_request_id?: string | null; p_due_date?: string | null; p_notes?: string | null; p_items?: import('@/lib/types').ProcurementLineInput[] | null }): ApiResult<RpcResult & { rfq_id?: string; rfq_number?: string; items_added?: number }> { return rpc('create_rfq', p); },
  updateRfqStatus(p: { p_rfq_id: string; p_status: string }): ApiResult<RpcResult> { return rpc('update_rfq_status', p); },
  recordSupplierQuotation(p: { p_rfq_id: string; p_supplier_id: string; p_valid_until?: string | null; p_delivery_days?: number | null; p_notes?: string | null; p_items: import('@/lib/types').ProcurementLineInput[] }): ApiResult<RpcResult & { quotation_id?: string; quotation_number?: string; items_added?: number; total?: number }> { return rpc('record_supplier_quotation', p); },
  selectSupplierQuotation(p: { p_quotation_id: string }): ApiResult<RpcResult> { return rpc('select_supplier_quotation', p); },
  getRfqComparison(p: { p_rfq_id: string }): ApiResult<import('@/lib/types').RfqComparisonRow[]> { return rpc('get_rfq_comparison', p); },
  createPurchaseOrder(p: { p_branch_id: string; p_supplier_id: string; p_warehouse_id?: string | null; p_payment_method?: string; p_notes?: string | null; p_items?: import('@/lib/types').ProcurementLineInput[] | null; p_quotation_id?: string | null }): ApiResult<RpcResult & { purchase_id?: string; invoice_number?: string; items_added?: number }> { return rpc('create_purchase_order', p); },
  ...
  receivePurchaseOrder(p: { p_purchase_id: string; p_receipt_items: import('@/lib/types').ReceiveLineInput[] }): ApiResult<RpcResult & { receipt_id?: string; receipt_number?: string; items_received?: number; fully_received?: boolean }> { return rpc('receive_purchase_order', p); },
  getPurchaseBackorders(p: { p_branch_id?: string | null }): ApiResult<import('@/lib/types').PurchaseBackorderRow[]> { return rpc('get_purchase_backorders', p); },
  getPurchaseReceipts(p: { p_branch_id?: string | null }): ApiResult<import('@/lib/types').PurchaseReceiptRow[]> { return rpc('get_purchase_receipts', p); },
  getSupplierEvaluation(p: { p_branch_id?: string | null }): ApiResult<import('@/lib/types').SupplierEvaluationRow[]> { return rpc('get_supplier_evaluation', p); },
};
...
export const inventory = {
  ...
  getLowStockAlerts(p: { p_branch_id?: string | null; p_warehouse_id?: string | null }): ApiResult<import('@/lib/types').LowStockAlertRow[]> { return rpc('get_low_stock_alerts', p); },
  ...
  getStockValuation(p: { p_branch_id?: string | null; p_warehouse_id?: string | null }): ApiResult<import('@/lib/types').StockValuationRow[]> { return rpc('get_stock_valuation', p); },
  getStockValuationSummary(p: { p_branch_id?: string | null; p_warehouse_id?: string | null }): ApiResult<import('@/lib/types').StockValuationSummaryRow[]> { return rpc('get_stock_valuation_summary', p); },
...
export const accounting = {
  getTrialBalance(p: { p_branch_id: string | null; p_to_date: string }): ApiResult<import('@/lib/types').TrialBalanceRow[]> { return rpc('get_trial_balance', p); },
  seedOpeningBalances(p: { p_branch_id: string | null }): ApiResult<RpcResult> { return rpc('seed_opening_balances', p); },
  getJournals(p: { p_branch_id: string | null; p_from_date: string | null; p_to_date: string | null; p_reference_type: string | null; p_search: string | null }): ApiResult<import('@/lib/types').JournalDto[]> { return rpc('get_journals', p); },
  ...
  getArAging(p: { p_branch_id: string | null; p_as_of: string }): ApiResult<import('@/lib/types').ArAgingRow[]> { return rpc('get_ar_aging', p); },
  getApAging(p: { p_branch_id: string | null; p_as_of: string }): ApiResult<import('@/lib/types').ApAgingRow[]> { return rpc('get_ap_aging', p); },
  ...
  getBankReconciliation(p: { p_reconciliation_id: string }): ApiResult<import('@/lib/types').ReconciliationDetail> { return rpc('get_bank_reconciliation', p); },
...
export const reporting = {
  getTrialBalance(p: { p_branch_id: string | null; p_to_date: string }): ApiResult<import('@/lib/types').TrialBalanceRow[]> { return rpc('get_trial_balance', p); },
  getTrialBalanceSummary(p: { p_branch_id: string | null; p_to_date: string }): ApiResult<import('@/lib/types').TrialBalanceSummary> { return rpc('get_trial_balance_summary', p); },
  getGeneralLedger(p: { p_branch_id: string | null; p_account_id: string | null; p_from_date: string | null; p_to_date: string | null }): ApiResult<import('@/lib/types').GeneralLedgerRow[]> { return rpc('get_general_ledger', p); },
  getIncomeStatement(p: { p_branch_id: string | null; p_from_date: string; p_to_date: string }): ApiResult<import('@/lib/types').IncomeStatementResult> { return rpc('get_income_statement', p); },
  getBalanceSheet(p: { p_branch_id: string | null; p_as_of: string }): ApiResult<import('@/lib/types').BalanceSheetResult> { return rpc('get_balance_sheet', p); },
  getArAging(p: { p_branch_id: string | null; p_as_of: string }): ApiResult<import('@/lib/types').ArAgingRow[]> { return rpc('get_ar_aging', p); },
  getApAging(p: { p_branch_id: string | null; p_as_of: string }): ApiResult<import('@/lib/types').ApAgingRow[]> { return rpc('get_ap_aging', p); },
  getAgingSummary(p: { p_branch_id: string | null; p_as_of: string }): ApiResult<import('@/lib/types').AgingSummaryResult> { return rpc('get_aging_summary', p); },
  getCashFlow(p: { p_branch_id: string | null; p_from_date: string; p_to_date: string }): ApiResult<import('@/lib/types').CashFlowRow[]> { return rpc('get_cash_flow', p); },
  getPartyStatement(p: { p_branch_id: string | null; p_side: string; p_party_id: string | null; p_from_date: string | null; p_to_date: string | null }): ApiResult<import('@/lib/types').PartyStatementResult> { return rpc('get_party_statement', p); },
};
